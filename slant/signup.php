				...
				<div class="col-md-8 col-md-offset-2">
					<div class="fh5co-hero-wrap">
						<div class="fh5co-hero-intro">
							<h1 class="to-animate hero-animate-1" style="color:#ff6a14;">Sign Up & Start Preparing Now !</h1>
		...
		<div id="fh5co-main">
			<div class="container">
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="fh5co-hero-wrap">
						<div class="fh5co-hero-intro">
						<h2 class="to-animate hero-animate-3">Or Have an Account</h2>
					...
					<div class="col-md-4">
						<h3>Need Help?</h3>
						<p>If You are having problem in signing up you can directly mail us at <a href="https://www.gmail.com">mohdshahrukh216@gmail.com</a> or <a href="https://www.gmail.com">misrar445@gmail.com</a>. We are here to help you!!</p>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12 footer-box">
						...
						<p>&copy; 2017 EX-PREP. All Rights Reserved. <br>Designed by <a href="#">Mohd Israr</a> & <a href="#">Mohd Shahrukh</a></p>
						</div>
					</div>
...
{ 	
 ...
 $insert_user = "INSERT INTO user(name,email,password) VALUES('$name','$email','$pass')";
